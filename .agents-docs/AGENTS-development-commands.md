...
node test/embedding-utils-features-test.js   # EU feature tests (16 tests)
node test/manifest-test.js        # manifest module tests (7 tests)
```

Run all tests at once:
```bash
node test/cluster-test.js && node test/embedding-utils-features-test.js && node test/manifest-test.js
```
